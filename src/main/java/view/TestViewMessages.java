 ...
 */
final class TestViewMessages extends NLS {
	...
	private static final String BUNDLE_NAME= TestViewMessages.class.getName();


	private TestViewMessages() {
		// Do not instantiate
	}
	...
	static {
		NLS.initializeMessages(BUNDLE_NAME, TestViewMessages.class);
	}
